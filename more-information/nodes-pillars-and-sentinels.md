...
Version v0.03 of the node is available for download here:

[https://github.com/zenon-network/go-zenon/releases/tag/v0.0.3-alphanet](https://github.com/zenon-network/go-zenon/releases/tag/v0.0.3-alphanet)

**I want to run a node locally on my own machine to speed up the network. How can I do that?**

You do not need ZNN or QSR in your wallet to run a node. Download the latest version of the node [here.](https://github.com/zenon-network/go-zenon/releases/tag/v0.0.3-alphanet) Link the node to your Syrius wallet. A quick guide is available here:
